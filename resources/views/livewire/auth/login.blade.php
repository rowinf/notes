...
<div class="flex flex-col gap-6">
    <x-auth-header title="Welcome to Note" description="Please log in to continue" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <!-- Remember Me -->
        <flux:checkbox wire:model="remember" hidden checked />
    ...
    <flux:button as="a" href="/auth/google" class="button-border"><flux:icon.icon-google></flux:icon.icon-google> Google</flux:button>
